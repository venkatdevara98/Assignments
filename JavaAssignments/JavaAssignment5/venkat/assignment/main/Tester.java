 ...
 */
package venkat.assignment.main;

import venkat.assignment.data.Printer;
import venkat.assignment.singleton.StringPrinter;

public class Tester {
    public static void main(String args[]){
        Printer printer=new Printer();
        printer.printInstanceVariables();
        printer.printLocalVariables();
        StringPrinter stringPrinter=StringPrinter.initializeString("This string");
