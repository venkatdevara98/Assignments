...
public class ElasticSearchManager {
    ...
    private static final String INDEX = "78395628"; // TODO: MUST CHANGE THIS to random number string
    ...
    public static class AddBidTask extends AsyncTask<Bidid,Boolean> {
