...
public class BasicDocument extends Document 
{
	...
	{
	    int numSyllables=0;
	    Pattern pattern1=Pattern.compile("[AEIOUaeiouYy]+");
	    Pattern patternLoneE=Pattern.compile("[^eEAIOUYaiouy]+[eE][ .,!?()]+|[^eEAIOUYaiouy]+[eE]$");
	    Pattern patternLoneEOnlyVowel=Pattern.compile("[ ]+[^AEIOUYaeiouy ]+[eE][ .,!?]+");
	    Matcher matcher1=pattern1.matcher(text);
	    while(matcher1.find())
	    	numSyllables++;
	    Matcher matcher2=patternLoneE.matcher(text);
	    while(matcher2.find())
	    	numSyllables--;
	    Matcher matcher3=patternLoneEOnlyVowel.matcher(text);
	    while(matcher3.find())
	    	numSyllables++;
        return numSyllables;
	}
